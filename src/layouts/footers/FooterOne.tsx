...
const FooterOne = () => {
	...
	return (
		(
			pathname.startsWith("/dashboard") || pathname.startsWith("/live-bids") || pathname.startsWith("/my-collection") || pathname.startsWith("/my-wallet") || pathname.startsWith("/notifications") || pathname.startsWith("/settings") ? null : (
				<>
					<footer
