                    ...
                    <div className="card-body">
                      <div className="img-wrap"><Image layout="fill" src={item.image} alt="" />
                        {item.badgeInfo[0].icon &&
                          <div className="badge bg-primary position-absolute"><Image layout="fill" src={item.badgeInfo[0].icon} alt="" />{item.badgeInfo[0].text}</div>
                        }
                      ...
                      <div className="row gx-2 align-items-center mt-2">
                        <div className="col-8">
                          <div className="name-info d-flex align-items-center">
                            <div className="author-img position-relative"><Image layout="fill" className="shadow" src={item.authorAvater} alt="" /><i className="bi bi-check position-absolute bg-success"></i></div>
