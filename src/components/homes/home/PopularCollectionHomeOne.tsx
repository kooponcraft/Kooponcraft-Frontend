                  ...
                  <div className="col-8">
                    ...
                    <div className="meta-info">
                      ...
                      <div className="price-bid d-flex align-items-center">
                        ...
                        </div><a className="btn btn-minimal btn-sm hover-primary d-flex align-items-center" href="#"><Image layout="fill" className="me-1" src="/assets/img/core-img/fire.png" alt="" />{item.buttonInfo[0].text}</a>
                      </div>
                    </div>
                  </div>
                </div>
