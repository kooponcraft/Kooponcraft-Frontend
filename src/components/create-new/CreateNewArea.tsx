            ...
            <div className="col-12 col-sm-8 col-lg-4">
              ...
              <div className="nft-card card shadow-sm">
                <div className="card-body">
                  <div className="img-wrap"><Image layout="fill" src="/assets/img/bg-img/17.jpg" alt="" />

                    <div className="badge bg-dark position-absolute"><Image layout="fill" src="/assets/img/core-img/fire.png" alt="" />Hot bid</div>
                  </div>
